  ...
  const reports: Report[] = [
    {
      ...
      type: "performance",
      generatedDate: "2024-01-18 16:30",
      size: "2.3 MB",
      format: "PDF",
      status: "ready",
    ...
    },
    {
      ...
      type: "progress",
      generatedDate: "2024-01-18 14:15",
      size: "1.8 MB",
      format: "Excel",
      status: "ready",
    ...
    },
    {
      ...
      type: "consortium",
      generatedDate: "2024-01-17 09:00",
      size: "3.1 MB",
      format: "PDF",
      status: "ready",
    ...
    },
    {
      ...
      type: "financial",
      generatedDate: "2024-01-16 11:45",
      size: "1.2 MB",
      format: "PDF",
      status: "ready",
    ...
    },
    {
      ...
      type: "performance",
      generatedDate: "2024-01-18 17:00",
      size: "0 KB",
      format: "PDF",
      status: "generating",
